...
<div style="background: linear-gradient(135deg, #0d3b66 0%, #3f8ed9 50%, #5b86e5 100%);
  ...
  <h1 style="text-align:center; margin-bottom:40px; color:#fff; font-family: 'Segoe UI', sans-serif;">Create Account</h1>

  <div class="d-flex justify-content-center mt-3">
    <form action="{{route('registration.post')}}" method="POST" style="
        width: 500px;
    ...
    ">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" style="border-radius:10px;">
        </div>
        <div class="mb-3">
